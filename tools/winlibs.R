if(!file.exists('bindings.o') && !file.exists('../.deps/libv8/include/v8.h')){
  ...
  url <- if(grepl("aarch", R.version$platform)){
    "https://github.com/r-windows/bundles/releases/download/v8-14.1.146.11/v8-14.1.146.11-clang-aarch64.tar.xz"
  } else if(grepl("clang", Sys.getenv('R_COMPILED_BY'))){
    "https://github.com/r-windows/bundles/releases/download/v8-14.1.146.11/v8-14.1.146.11-clang-x86_64.tar.xz"
  } else if(getRversion() >= "4.3") {
    "https://github.com/r-windows/bundles/releases/download/v8-14.1.146.11/v8-14.1.146.11-ucrt-x86_64.tar.xz"
