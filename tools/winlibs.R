if(!file.exists('bindings.o') && !file.exists('../.deps/libv8/include/v8.h')){
  ...
  url <- if(grepl("aarch", R.version$platform)){
    "https://github.com/r-windows/bundles/releases/download/v8-14.6.202.26/v8-14.6.202.26-clang-aarch64.tar.xz"
  } else if(grepl("clang", Sys.getenv('R_COMPILED_BY'))){
    "https://github.com/r-windows/bundles/releases/download/v8-14.6.202.26/v8-14.6.202.26-clang-x86_64.tar.xz"
  } else if(getRversion() >= "4.4") {
    "https://github.com/r-windows/bundles/releases/download/v8-14.6.202.26/v8-14.6.202.26-ucrt-x86_64.tar.xz"
