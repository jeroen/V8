...
echo "_global.beautify = require('js-beautify')" > in.js
browserify in.js -o beautify.js
```

The first line will install js-beautify in a the current dir under `node_modules`.
The second line creates the input file for browserify. 
In this case it consists of a single line that assigns the js-beautify library to a global object `beautify`.
The third line runs browserify and saves the output to a new file `beautify.js`.
